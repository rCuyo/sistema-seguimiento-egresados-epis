...
import { ArrowLeft, MapPin, Building2, Globe, BadgeCheck, Clock, Monitor } from "lucide-react"
import { getServerSession } from "next-auth"
import { authOptions }      from "@/lib/auth"
import { getJobDetailPublic, getGraduateApplications } from "@/lib/services/jobs.service"
...
export default async function EgresadoEmpleoDetailPage({ params }: PageProps) {
  ...
  if (!job) redirect("/egresado/empleos")
